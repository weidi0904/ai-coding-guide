...
先打个招呼：如果你是刚看完 Claude Code 篇拐过来的，恭喜，你已经赢在起跑线上了。Codex 和 Claude Code 是一个物种，骨架几乎一模一样——「代理循环」那套你早就懂了。这一篇不会再把同样的道理重讲一遍，而是带你看 **Codex 把这套东西换了哪些名字、加了哪些自己的料**。

说个我自己干的蠢事。我刚从 Claude Code 切到 Codex 那会儿，张口就问它「帮我把这三个文件批量重命名」，它噼里啪啦改完，我一看傻眼了——它只动了当前项目目录里的，我桌面上那两个**纹丝没动**。我当时还纳闷：不是说能跑命令吗，咋还挑食？后来翻文档才反应过来：那是**沙箱（Sandbox）**在拦着，它默认只能在你指定的工作区里动手，出了这个圈得先问你。
