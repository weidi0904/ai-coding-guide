...
它跑在 [chatgpt.com/codex](https://chatgpt.com/codex) ，第一次用要做一件事：**连上你的 GitHub 账号**。连上之后，Codex 才能读你仓库里的代码、并从它的改动里给你开 Pull Request（拉取请求，简称 PR，就是「我改好了，请你 review 后合并」的提交方式）。
